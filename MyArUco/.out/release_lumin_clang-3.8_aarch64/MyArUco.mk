...
MyArUco_CXXFLAGS=--sysroot=$(MLSDK)/lumin -march=armv8-a -mcpu=cortex-a57+crypto -fPIC -fpic -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -Wa,--noexecstack -Wformat -Werror=format-security -Wno-invalid-command-line-argument -Wno-unused-command-line-argument -g -fno-limit-debug-info -O2 -std=c++11 -nostdinc++ -I$(MLSDK)/lumin/stl/libc++/include -fdiagnostics-format=msvc
...
$(MyArUco_OUTPUT)/libMyArUco.so : $(MyArUco_OUTPUT)/obj.MyArUco/src/MyArUco.cpp.o $(MyArUco_BASE)/MyArUco.mabu $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/configs/release.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/on.option $(MLSDK)/tools/mabu/data/options/package/debuggable/off.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/stl/libc++.option $(MLSDK)/tools/mabu/data/options/warn/on.option
